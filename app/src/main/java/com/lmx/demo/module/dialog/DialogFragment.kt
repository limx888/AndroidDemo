package com.lmx.demo.module.dialog
...
import com.lmx.demo.utils.DrawableUtils
import com.lmx.base.base.BaseDialogFragment
...
class DialogFragment : BaseDialogFragment<DialogViewModel, ViewDataBinding>() {
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            title = bundle.getString(ConstantsKey.CommonTitle)
            desc = bundle.getString(ConstantsKey.CommonDesc)
            left = bundle.getString(ConstantsKey.CommonLeft)
            right = bundle.getString(ConstantsKey.CommonRight)
            remind = bundle.getString(ConstantsKey.CommonRemind)
            externalArea = bundle.getBoolean(ConstantsKey.CommonExternalArea)
        }
        //样式的展示
        //标题
        //样式的展示
