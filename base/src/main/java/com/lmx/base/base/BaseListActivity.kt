...
import com.lmx.base.R
import com.lmx.base.config.BaseConfig
import com.lmx.base.mvvm.BaseListViewModel
import com.lmx.base.mvvm.IListView
import com.lmx.base.utils.ActivityUtils
import com.lmx.base.utils.ListUtils
import com.lmx.base.utils.ToastUtils
import com.lmx.base.view.IVaryViewHelperController
import com.lmx.base.view.VaryViewHelperController
 ...
 * @Modified By:
 */
abstract class BaseListActivity<VM : BaseListViewModel<*>, DB : ViewDataBinding, A : BaseQuickAdapter<T, BaseViewHolder>, T> :
    AppCompatActivity(),
    IListView<T> {
