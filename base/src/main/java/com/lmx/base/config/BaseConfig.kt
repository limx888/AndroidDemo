package com.lmx.base.config

import com.lmx.base.http.interceptor.IReturnCodeErrorInterceptor
import com.lmx.base.http.interceptor.IVersionDifInterceptor
...
object BaseConfig {
    ...
    class ConfigBuilder {
        ...
        fun setCacheOpen(cacheOpen: Boolean): ConfigBuilder {
            BaseConfig.cacheOpen = cacheOpen
            return this
        }

        fun setConfigBuilder(configBuilder: ConfigBuilder?): ConfigBuilder {
            BaseConfig.configBuilder = configBuilder
            return this
        }
